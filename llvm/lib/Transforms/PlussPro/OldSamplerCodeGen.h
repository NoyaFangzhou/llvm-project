...
#ifndef LLVM_OLDSAMPLERCODEGEN_H
#define LLVM_OLDSAMPLERCODEGEN_H
...
struct OldSamplerCodeGenWrapperPass : FunctionPass {

  static char ID;
  OldSamplerCodeGenWrapperPass();
...
} // end of OldSamplerCodeGen namespace

#endif // LLVM_OLDSAMPLERCODEGEN_H
