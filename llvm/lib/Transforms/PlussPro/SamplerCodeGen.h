...
#ifndef LLVM_SAMPLERCODEGEN_H
#define LLVM_SAMPLERCODEGEN_H
...
struct SamplerCodeGenWrapperPass : FunctionPass {

  static char ID;
  SamplerCodeGenWrapperPass();
...
} // end of SamplerCodeGen namespace

#endif // LLVM_SAMPLERCODEGEN_H